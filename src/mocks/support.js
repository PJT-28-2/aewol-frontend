...
// 버킷 개수 제한/SOS 포켓 질문은 해당 기능이 없어서 삭제함(2026-08-11).
...
export const MOCK_FAQ_ANSWERS = {
  ...
  4: '탈퇴 즉시 애월지갑 잔액, 버킷, SOS포켓, 저금통 정보가 모두 삭제되며 복구되지 않아요.\n\n결제·정산 내역과 반려동물 프로필도 함께 삭제돼요. 가족 공유(공동육아)로 연결되어 있던 구성원과의 연결 정보, 연동된 계좌 정보도 모두 해제돼요.\n\n탈퇴 전 꼭 필요한 자료(증명서, 청구서류 등)는 미리 다운로드해두시는 걸 추천드려요.',
