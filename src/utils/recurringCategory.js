...
export const RECURRING_CATEGORIES = [
  { key: 'MEDICAL', label: CATEGORY_LABELS.MEDICAL, icon: IconHospital, bg: 'var(--color-pastel-blue)' },
  { key: 'GROOMING', label: CATEGORY_LABELS.GROOMING, icon: IconBarberShop, bg: 'var(--color-pastel-lilac)' },
  { key: 'FOOD', label: CATEGORY_LABELS.FOOD, icon: IconDogBowl, bg: 'var(--color-pastel-peach)' },
  { key: 'SUPPLIES', label: CATEGORY_LABELS.SUPPLIES, icon: IconShowerGel, bg: 'var(--color-pastel-mint)' },
  { key: 'ETC', label: CATEGORY_LABELS.ETC, icon: IconEtc, bg: 'var(--color-pastel-beige)' },
]
