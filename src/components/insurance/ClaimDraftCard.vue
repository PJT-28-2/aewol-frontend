    ...
    <ul>
      ...
      >
        ...
        >
          ...
          <span class="shrink-0 rounded-(--radius-full) bg-(--color-leaf-soft) px-(--space-2) py-[3px] text-(length:--font-xs) font-semibold text-(color:--color-leaf-dark)">
            {{ field.badgeLabel }}
          </span>
        </div>
      </li>
